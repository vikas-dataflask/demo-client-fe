...
const HeatLoad = () => {
  ...
  return (
    <div className="flex h-screen">
      <div className="bg-white px-4 pt-4 pb-6 border-r border-gray-200 w-[400px] font-sans text-[13px] overflow-hidden relative h-[93vh] overflow-y-auto flex flex-col">
        {/* Header */}
